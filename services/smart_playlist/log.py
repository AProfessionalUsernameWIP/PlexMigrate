"""Smart Playlist Migration job log with dedicated rotating file handler and token scrubbing."""
...
def get_smart_playlist_logger() -> logging.Logger:
    """Return the dedicated Smart Playlist Migration logger with propagate=False.
    
    Idempotent. Returns a usable Logger even on setup failure (with NullHandler).
    """
