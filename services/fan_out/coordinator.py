"""Fan-out coordinator: drive one job that targets multiple destinations in parallel."""
...
log = logging.getLogger("plexmigrate.services.fan_out.coordinator")
...
def _run_one_direct_destination(
    *,
    ...
    try:
        ...
        # between server.jobs and services.fan_out.coordinator.
