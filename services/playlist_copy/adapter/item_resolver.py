"""4-tier source-to-destination playlist item resolution for extracted resolver kernel."""
...
def resolve_item_to_dest(
    ...
    *,
    ...
    # Fuzzy 'all'-mode produces N ids for one source item; every other
    # tier produces exactly one.
