...
# services.sync_log for the full rationale.
from services.sync_log import get_sync_logger
log = get_sync_logger()
...
# services.user_resolution chain).
#
...
def _resolve_users_for_sub(
    ...
    *,
    ...
    #
    # Route through services.user_activity_filter so
...
def _resolve_dest_user_for_sync(
    *,
    ...
    is on). The full 5-step chain in services.user_resolution is
